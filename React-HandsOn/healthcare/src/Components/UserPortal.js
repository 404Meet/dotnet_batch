    ...
    <div>
      <BrowserRouter>
            ...
            <div className="App container d-flex flex-row">
                ...
                <br></br> */}
                <NavLink id="login" className="form-control btn btn-primary m-1"  to="/ucategory">&nbsp;Categories</NavLink>
                <NavLink id="register" className="form-control btn btn-primary m-1" to="/umedicine">Medicines</NavLink>
            </div>
            <Switch>
